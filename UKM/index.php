            ...
            <form action="proses_daftar.php" method="POST"> 
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control" id="var_npm" placeholder="Input Nomor Pengenal Siswa (NPM)" name="var_npm">
                    </div>
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <select name="var_ukm" class="form-select">
                            ...
                            <option>UKM Badminton</option>
                            <option>UKM VolleyBall</option>
                            <option>UKM Paradica</option>
                            <option>UKM LDK</option>
                            <option>UKM PERMADHIS</option>
                            <option>UKM PMK</option>
                            <option>UKM Esports</option>
                            <option>UKM Sendrata</option>
                            <option>UKM Pecinta Alam</option>
                        </select>
                    </div>
